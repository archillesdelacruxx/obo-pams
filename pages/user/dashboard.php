...
<head>
  ...
  <title>Dashboard · PAMS User</title>
  ...
  <div class="app-shell" id="appShell">
    ...
    <div class="main-col">
      ...
      <main class="page-content fade-in">
        ...
        <div class="page-head">
          <div>
            <h1 id="userGreeting"><?php echo $greeting; ?>, <?php echo escape($firstName); ?> 👋</h1>
        ...
        <div class="quick-access-grid">
          ...
          <?php endif; ?>
          <a href="notifications.php" class="quick-card" data-user-nav="notifications.php">
            <div class="qc-icon icon-red"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg></div>
            <div class="qc-body"><strong>Notifications</strong><span>View recent notifications</span></div>
            <div class="qc-arrow"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 6l6 6-6 6"/></svg></div>
          </a>
        ...
        <div class="two-col">
          <div>
            ...
            <div class="analytics-placeholder" style="margin-top:22px;">
              <div class="placeholder-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20V10M12 20V4M20 20v-7"/></svg></div>
              <h4>Analytics Coming Soon</h4>
              <p>Personal productivity charts and trend reports will be available in a future update.</p>
            </div>
          </div>
          <div>
            <div class="section-card">
              <div class="section-head"><h3>My Notifications</h3><a href="notifications.php" data-user-nav="notifications.php" class="btn btn-secondary" style="padding:6px 12px;font-size:12px;">View all</a></div>
              <div class="section-body" id="userNotifFeed" style="padding-top:4px;padding-bottom:4px;"></div>
            </div>
